...
export default React.memo(({addPost, posts}) => {

    const postsData = posts.map(p => <Post name={p.name} likes={p.likes} shares={p.shares} comments={p.comments}
...
const AddPostForm = ({handleSubmit}) => {
    return <form onSubmit={handleSubmit} className={styles.newPost}>
        <img className={styles.post__ava} src={userPhoto} alt="Avatar"/>
